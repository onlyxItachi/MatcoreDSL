# Claim Hardening Registry: CPU Decision Architecture

**Audit Context**: Evidence-Depth Realignment Pass over Commits `76b7246`, `931ccc9`, `eef3efe`, `17f30d1`, `2568fb2`, `824f773`, and `cec0700`.  
**Principle**: `BREADTH = FROZEN`, `DEPTH = MAXIMUM`. Every strong or "universal" claim has been subjected to claim-specific acceptance tests and recalibrated.

---

## 1. Audited Claim Status Ledger
...
| **HARDEN-04** | Packing Performance Numbers | `STRONGLY_SUPPORTED` | **RECALIBRATED** | `REPLICATED_OBSERVATION` | Sourced library thresholds (OpenBLAS `GEMM_P=504`, `GEMM_Q=128`); replaced global % with theoretical formula. |
