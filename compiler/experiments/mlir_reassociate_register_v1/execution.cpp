// Research-only direct-leaf oracle. No source/candidate issuance or FP-adapter
// claim: the research caller establishes the documented execution environment.
#include <algorithm>
#include <bit>
#include <cfenv>
#include <cmath>
...
int main(int argc, char **argv) {
  ...
  check(fesetenv(&saved) == 0, "research harness restores original FP environment");
  std::printf("reassociate register research: %llu cases; %llu checks; %llu failures\n",
