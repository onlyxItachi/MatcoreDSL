...
extern "C" matcore_status_v0 matcore_generated_backend_mc_2ed9c564471bcc43_v0(const matcore_tensor_desc_v0 *, const matcore_tensor_desc_v0 *, const matcore_tensor_desc_v0 *, const matcore_policy_v0 *) noexcept;
...
void __matcore_call_site_mc_2ed9c564471bcc43(out_arg output, const matrix_view &lhs, const matrix_view &rhs, policy execution_policy) {
  ...
  const matcore_status_v0 status = matcore_generated_backend_mc_2ed9c564471bcc43_v0(&output_descriptor, &lhs_descriptor, &rhs_descriptor, &runtime_policy);
